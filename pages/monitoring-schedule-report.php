...
<body>
    ...
    if (!empty($_POST["submit"])) {
        ...
        if ($group == "ALL") {
            ...
            a.warna, a.no_warna, sum(a.rol) as rol, sum(a.bruto) as bruto, a.proses, a.status, a.lot, a.catatan, a.ket_status, a.nokk_legacy,
            ...
            where a.status = 'selesai' AND a.leader_check = 'TRUE' and  SUBSTRING(CONVERT(VARCHAR(16), a.tgl_update, 120),1,10) >= '$date_s' 
            AND  SUBSTRING(CONVERT(VARCHAR(16), a.tgl_update, 120),1,10) <= '$date_e'
            GROUP by  a.id, a.nodemand, a.no_mesin, a.no_urut, a.buyer, a.langganan, a.no_order, a.nokk, 
                a.jenis_kain, a.warna, a.no_warna, a.proses, a.dept_tujuan, a.pic_schedule, 
                a.status, a.lot, a.catatan, a.ket_status, a.nokk_legacy,
                a.tgl_delivery, a.create_time, a.tgl_mulai, a.tgl_update, a.tgl_stop, a.approve_time, 
            ...
            if ($_POST["w_shift"] != 'ALL') {
                if ($_POST['w_shift'] == 1) {
                    $start_shift3 = $_POST["date-start"] . " 07:00";
                    $end_shift3 = $_POST["date-end"] . " 15:00";
                } else if ($_POST['w_shift'] == 2) {
                    $start_shift3 = $_POST["date-start"] . " 15:00";
                    $end_shift3 = $_POST["date-end"] . " 23:00";
                } else if ($_POST['w_shift'] == 3) {
                    $start_shift3 = $_POST["date-start"] . " 23:00";
                    $end_shift3 = $_POST["date-end"] . " 07:00";
                }
                $data = sqlsrv_query($con, "SELECT a.id, a.nodemand, a.no_mesin, a.no_urut, a.buyer, a.langganan, a.no_order, a.nokk, a.jenis_kain,
                a.warna, a.no_warna, sum(a.rol) as rol, sum(a.bruto) as bruto, a.proses, a.status, a.lot, a.catatan, a.ket_status, a.nokk_legacy,
                a.tgl_delivery, a.create_time, a.tgl_mulai, a.tgl_update, a.tgl_stop, a.approve_time, b.no_gerobak1, b.tgl_out1, b.no_gerobak2, b.tgl_out2, b.no_gerobak3, b.tgl_out3, b.no_gerobak4, 
                ...
                FROM db_ikg.tbl_schedule a
                join db_ikg.tbl_gerobak b on a.id = b.id_schedule
                where a.status = 'selesai' AND a.leader_check = 'TRUE' and a.g_shift = '$group' and
               CONVERT(VARCHAR(16), a.tgl_update, 120) >= '$start_shift3' 
                AND CONVERT(VARCHAR(16), a.tgl_update, 120) <= '$end_shift3'
                GROUP by  a.id, a.nodemand, a.no_mesin, a.no_urut, a.buyer, a.langganan, a.no_order, a.nokk, 
                a.jenis_kain, a.warna, a.no_warna, a.proses, a.dept_tujuan, a.pic_schedule, 
                a.status, a.lot, a.catatan, a.ket_status, a.nokk_legacy,
                a.tgl_delivery, a.create_time, a.tgl_mulai, a.tgl_update, a.tgl_stop, a.approve_time, 
                ...
                FROM db_ikg.tbl_schedule a
                join db_ikg.tbl_gerobak b on a.id = b.id_schedule
                where a.status = 'selesai' AND a.leader_check = 'TRUE' and a.g_shift = '$group' and SUBSTRING(CONVERT(VARCHAR(16), a.tgl_update, 120),1,10)  >= '$date_s' 
                AND SUBSTRING(CONVERT(VARCHAR(16), a.tgl_update, 120),1,10)  <= '$date_e'
                GROUP by  a.id, a.nodemand, a.no_mesin, a.no_urut, a.buyer, a.langganan, a.no_order, a.nokk, 
                a.jenis_kain, a.warna, a.no_warna, a.proses, a.dept_tujuan, a.pic_schedule, 
                a.status, a.lot, a.catatan, a.ket_status, a.nokk_legacy,
        ...
        FROM db_ikg.tbl_schedule a
        join db_ikg.tbl_gerobak b on a.id = b.id_schedule
        WHERE a.status = 'selesai' AND a.leader_check = 'TRUE' and SUBSTRING(CONVERT(VARCHAR(16), a.tgl_update, 120),1,10)  = CAST(GETDATE() AS DATE)
        GROUP BY  a.id, a.nodemand, a.no_mesin, a.no_urut, a.buyer, a.langganan, a.no_order, a.nokk, 
                a.jenis_kain, a.warna, a.no_warna, a.proses, a.dept_tujuan, a.pic_schedule, 
                a.status, a.lot, a.catatan, a.ket_status, a.nokk_legacy,
                a.tgl_delivery, a.create_time, a.tgl_mulai, a.tgl_update, a.tgl_stop, a.approve_time, 
    ...
    ?>
    <div class="row">
        <p style="font-weight: bold; color: red; font-style: italic; margin-left: 20px;">Untuk men-genarate laporan
            shift 3, maka ambil tanggal pada shift di mulai S/D tanggal shift berakhir dan centang checkbox shift 3
        </p>
        <div class="col-xs-12">
            <div class="box">
                        ...
                        <div class="form-group row">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-2">
                                        <select required name="g_shift" class="form-control input-sm" required>
                                            <option <?php if ($group == "ALL")
                                                echo "selected"; ?> value="ALL">ALL GROUP
                                            </option>
                                            <option <?php if ($group == "A")
                                                echo "selected"; ?> value="A">A</option>
                                            <option <?php if ($group == "B")
                                                echo "selected"; ?> value="B">B</option>
                                            <option <?php if ($group == "C")
                                                echo "selected"; ?> value="C">C</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-2">
                                        <select required name="w_shift" class="form-control input-sm" required>
