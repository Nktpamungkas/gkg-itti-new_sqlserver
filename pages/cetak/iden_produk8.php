...
<body>
  ...
  border-right:1px #000000 solid;"><?php if ($data['dept_tujuan'] == 'QCF') echo "<b>√</b>" ?>
      ...
      <tr>
        ...
        <td valign="top">: <?php echo cek($data['tgl_out6'],'Y-m-d H:i:s') ?> <b style="font-style: italic;">*</b></td>
      </tr>
      <tr valign="top">
      ...
      <tr>
        <td colspan="3">
          <table width="100%" border="0">
            <tbody>
              <tr>
                <td width="8%" valign="top" style="height: 0.4in;" scope="col">1. <span style="height: 0.4in;"><?php echo $data['no_gerobak1']  ?></span></td>
                <td width="8%" valign="top" scope="col">2. <span style="height: 0.4in;"><?php echo $data['no_gerobak2']  ?></span></td>
                <td width="8%" valign="top" scope="col">3. <span style="height: 0.4in;"><?php echo $data['no_gerobak3']  ?></span></td>
                <td width="8%" valign="top" scope="col">4. <span style="height: 0.4in;"><?php echo $data['no_gerobak4']  ?></span></td>
                <td width="8%" valign="top" scope="col">5. <span style="height: 0.4in;"><?php echo $data['no_gerobak5']  ?></span></td>
                <td width="8%" valign="top" scope="col">6. <span style="height: 0.4in;"><?php echo $data['no_gerobak6']  ?></span></td>
                <td width="8%" valign="top" scope="col">7. <span style="height: 0.4in;"><?php echo $data['no_gerobak7']  ?></span></td>
                <td width="8%" valign="top" scope="col">8. <span style="height: 0.4in;"><?php echo $data['no_gerobak8']  ?>*</span></td>
              </tr>
            </tbody>
          </table>
        </td>
