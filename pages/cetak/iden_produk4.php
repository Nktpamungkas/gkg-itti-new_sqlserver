...
<body>
  ...
  <table width="100%" border="" class="table-list1">
	...
	border-top:1px #000000 solid;
	border-left:1px #000000 solid;
  border-right:1px #000000 solid;"><?php if ($data['dept_tujuan'] == 'BRS') echo "GKG√</b>" ?>
                </td>
                <td width="93%">GKG</td>
              </tr>
              <tr>
  ...
  border-right:1px #000000 solid;"><?php if ($data['dept_tujuan'] == 'QCF') echo "<b>√</b>" ?>
      ...
      <tr>
        ...
        <td valign="top">: <?php echo cek($data['tgl_out4'],'Y-m-d H:i:s') ?> <b style="font-style: italic;">*</b></td>
      </tr>
      <tr valign="top">
      ...
      <tr>
        <td colspan="3">
          <table width="100%" border="0">
            <tbody>
              <tr>
                <td width="20%" valign="top" style="height: 0.4in;" scope="col">1. <span style="height: 0.4in;"><?php echo $data['no_gerobak1']  ?></span></td>
                <td width="20%" valign="top" scope="col">2. <span style="height: 0.4in;"><?php echo $data['no_gerobak2']  ?></span></td>
                <td width="20%" valign="top" scope="col">3. <span style="height: 0.4in;"><?php echo $data['no_gerobak3']  ?></span></td>
                <td width="20%" valign="top" scope="col">4. <span style="height: 0.4in;"><?php echo $data['no_gerobak4']  ?>*</span></td>
                <td width="20%" valign="top" scope="col">5. <span style="height: 0.4in;"></span></td>
              </tr>
            </tbody>
          </table>
        </td>
