...
<body>
  ...
  border-right:1px #000000 solid;"><?php if ($data['dept_tujuan'] == 'QCF') echo "<b>√</b>" ?>
      ...
      <tr>
        ...
        <td valign="top">: <?php echo cek($data['tgl_out5'],"Y-m-d H:i:s") ?> <b style="font-style: italic;">*</b></td>
      </tr>
      <tr valign="top">
          ...
          <table width="100%" border="0">
            <tbody>
              <tr>
                ...
                <td width="20%" valign="top" scope="col">5. <span style="height: 0.4in;"><?php echo $data['no_gerobak5']  ?>*</span></td>
              </tr>
            </tbody>
          </table>
        </td>
