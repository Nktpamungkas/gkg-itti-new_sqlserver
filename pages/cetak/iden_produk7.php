      ...
      <tr>
        <td colspan="3">
          <table width="100%" border="0">
            <tbody>
              <tr>
                <td width="12%" valign="top" style="height: 0.4in;" scope="col">1. <span style="height: 0.4in;"><?php echo $data['no_gerobak1']  ?></span></td>
                <td width="12%" valign="top" scope="col">2. <span style="height: 0.4in;"><?php echo $data['no_gerobak2']  ?></span></td>
                <td width="12%" valign="top" scope="col">3. <span style="height: 0.4in;"><?php echo $data['no_gerobak3']  ?></span></td>
                <td width="12%" valign="top" scope="col">4. <span style="height: 0.4in;"><?php echo $data['no_gerobak4']  ?></span></td>
                <td width="12%" valign="top" scope="col">5. <span style="height: 0.4in;"><?php echo $data['no_gerobak5']  ?></span></td>
                <td width="12%" valign="top" scope="col">6. <span style="height: 0.4in;"><?php echo $data['no_gerobak6']  ?></span></td>
                <td width="12%" valign="top" scope="col">7. <span style="height: 0.4in;"><?php echo $data['no_gerobak7']  ?>*</span></td>
              </tr>
            </tbody>
          </table>
        </td>
