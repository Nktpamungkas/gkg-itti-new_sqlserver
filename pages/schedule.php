...
<body>
  ...
  $data = sqlsrv_query($con, "SELECT
    ...
    a.jenis_kk,
    a.create_time,
    DATEDIFF(DAY, a.create_time, GETDATE()) AS sisa,
    a.tgl_update
FROM
...
");
  ...
  ?>
        ...
        <div class="col-xs-12">
            ...
            echo 'btn-success';
                ...
                while ($rowd = sqlsrv_fetch_array($data)) {
                  ...
                  $qCek = sqlsrv_query($con, "SELECT `status` FROM db_ikg.tbl_produksi WHERE id_schedule='$rowd[id]' LIMIT 1");
                  $rCEk = sqlsrv_fetch_array($qCek);
                  ?>
                                <div class="modal fade modal-super-scaled" id="PrintHalaman<?php echo $rowd['id']; ?>">
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content">
                                            <form class="form-horizontal" name="modal_popup" data-toggle="validator"
                                                ...
                                                <div class="modal-body" align="center">
                                                    <a href="pages/cetak/iden_produk1.php?idkk=<?php echo $rowd['id']; ?>"
                                                        class="btn btn-danger" target="_blank"><i
                                                            class="fa fa-print"></i> Gerobak ke-1</a>
                                                    <a href="pages/cetak/iden_produk2.php?idkk=<?php echo $rowd['id']; ?>"
                                                        class="btn btn-danger" target="_blank"><i
                                                            class="fa fa-print"></i> Gerobak ke-2</a><br><br>
                                                    <a href="pages/cetak/iden_produk3.php?idkk=<?php echo $rowd['id']; ?>"
                                                        class="btn btn-success" target="_blank"><i
                                                            class="fa fa-print"></i> Gerobak ke-3</a>
                                                    <a href="pages/cetak/iden_produk4.php?idkk=<?php echo $rowd['id']; ?>"
                                                        class="btn btn-success" target="_blank"><i
                                                            class="fa fa-print"></i> Gerobak ke-4</a><br><br>
                                                    <a href="pages/cetak/iden_produk5.php?idkk=<?php echo $rowd['id']; ?>"
                                                        class="btn btn-primary" target="_blank"><i
                                                            class="fa fa-print"></i> Gerobak ke-5</a>
                                                    <a href="pages/cetak/iden_produk6.php?idkk=<?php echo $rowd['id']; ?>"
                                                        class="btn btn-primary" target="_blank"><i
                                                            class="fa fa-print"></i> Gerobak ke-6</a>
                                                </div>
                                ...
                                <tr bgcolor="<?php echo $bgcolor; ?>">
                                    ...
                                    <td align="center">
                                        <font size="-1"><?php echo $rowd['g_shift']; ?><br>
                                            <div class="btn-group">
                                                <a href="index1.php?p=schedule_edit_admin&id=<?php echo $rowd['id']; ?>"
                                                    id='
                          <?php echo $rowd['id']; ?>' class="btn btn-xs btn-info schedule_edit <?php if ($_SESSION['nama1Gkg'] != "GKG-LEADER")
                              echo " disabled"; ?>">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="#" onclick="confirm_del('HapusSch-<?php echo $rowd['id'] ?>');"
                                                    class="btn btn-xs btn-danger <?php if ($_SESSION['nama1Gkg'] != "GKG-LEADER")
                              echo " disabled"; ?>">
                        ...
                        ?>' class="edit_status_mesin <?php if ($_SESSION['lvl_idGkg'] == "USER")
                          echo " disabled"; ?>">
                          <?php echo $rowd['no_mesin']; ?>
                        </a></font>-->
                                        <strong><?php echo $rowd['create_time']; ?></strong><br>
                                        <?php if (abs($rowd['sisa']) == "0") {
                        echo "<span class='badge bg-blue'>New</span>";
                      } else {
                        echo "<span class='badge bg-red'>" . abs($rowd['sisa']) . " Hari</span>";
                      } ?>
                                    </td>
                                    <td align="center">
                                        <font size="-1">
                                            <?php echo $rowd['pic_schedule']; ?>/<?php echo $rowd['no_urut']; ?>/
                                            <a href="#" id='<?php echo $rowd['id']; ?>' class="btn btn-xs btn-warning mesin_mulai_edit <?php if ($_SESSION['lvl_idGkg'] == 'ADMIN')
                            echo " disabled"; ?>">mulai
                                            </a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <font size="-1"><?php echo $rowd['no_hanger']; ?></font>
                                    </td>
                                    <td>
                                    ...
                                    <td align="center">
                                        <font size="-1"><?php if ($rowd['nodemand'] != ""): ?>
                                            <a target="_BLANK"
                                                href="http://10.0.0.10/laporan/ppc_filter_steps.php?demand=<?= $rowd['nodemand']; ?>&prod_order=<?= $rowd['nokk']; ?>">`<?= $rowd['nodemand']; ?></a>
                                            <?php else: ?>
                                            <?= $rowd['lot']; ?>
                                            <?php endif; ?>
                                            <br />
                                            <a href="#" class="posisi_kk"
                                                id="<?php echo $rowd['nokk_legacy']; ?>"><?php echo $rowd['nokk_legacy']; ?></a>
                                            <br />
                                            <?php if ($rowd['jenis_kk'] != "") {
                          echo $rowd['jenis_kk'];
                        } ?>
                                        </font>
                                    </td>
                                    <td>
                                        <font size="-1"><i><?php echo $rowd['nokk']; ?></i><br />
                                            <i
                                                style="color:red;"><strong><?php echo $rowd['catatan']; ?></strong></i><br />
                                            <a href="#" id='<?php echo $rowd['id']; ?>' class="detail_kartu"><span
                                                    class="label label-danger"><?php echo $rowd['ket_kartu']; ?></span></a><?php echo $rowd['tgl_update']; ?>
                                        </font>
                                    </td>
                                    <td align="center">
    ...
    <div id="PosisiKK" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
