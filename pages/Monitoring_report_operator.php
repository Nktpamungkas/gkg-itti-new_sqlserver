...
$sql_user = sqlsrv_query($con, "SELECT * from db_ikg.tbl_user a where a.level = 'USER' ");
?>
...
<body>
    ...
    if (!empty($_POST["submit"])) {
        ...
        if ($operator == "ALL") {
            $data = sqlsrv_query($con, "SELECT 
                                                ...
                                                WHERE 
                                                    ...
                                                    AND CONVERT(DATE, a.tgl_update) >= CONVERT(DATE, '$date_s') 
                                                    AND CONVERT(DATE, a.tgl_update) <= CONVERT(DATE, '$date_e')
                                                GROUP BY 
                                                    a.no_mesin, a.no_urut, a.id, a.nodemand, a.buyer, a.langganan, a.no_order, 
                                                    a.nokk, a.jenis_kain, a.warna, a.no_warna, a.proses, a.dept_tujuan, 
                                                    a.pic_schedule, a.status, a.lot, a.catatan, a.ket_status, 
                                                    a.nokk_legacy, a.tgl_delivery, a.create_time, 
                                                    a.tgl_mulai, a.tgl_update, a.tgl_stop, a.approve_time, 
                                                    b.no_gerobak1, b.tgl_out1, b.no_gerobak2, b.tgl_out2, 
                                                    b.no_gerobak3, b.tgl_out3, b.no_gerobak4, 
                                                    b.tgl_out4, b.no_gerobak5, b.tgl_out5, 
            ...
            where a.status = 'selesai' AND a.leader_check = 'TRUE' and a.petugas_buka = '$operator' and FORMAT(a.tgl_update, 'yyyy-MM-dd') >= '$date_s' 
            AND FORMAT(a.tgl_update, 'yyyy-MM-dd') <= '$date_e'
        ...
        FROM db_ikg.tbl_schedule a
        join db_ikg.tbl_gerobak b on a.id = b.id_schedule
        WHERE a.status = 'selesai' AND a.leader_check = 'TRUE' and FORMAT(a.tgl_update, 'yyyy-MM-dd') = CONVERT(varchar, GETDATE(), 23)
        GROUP BY 
		a.id, a.nodemand, a.no_mesin, a.no_urut, a.buyer, a.langganan, a.no_order, a.nokk, 
        a.jenis_kain, a.warna, a.no_warna, a.proses, a.dept_tujuan, a.pic_schedule, 
        a.status, a.lot, a.catatan, a.ket_status, a.nokk_legacy,
        a.tgl_delivery, a.create_time, a.tgl_mulai, a.tgl_update, a.tgl_stop, a.approve_time, 
        b.no_gerobak1, b.tgl_out1, b.no_gerobak2, b.tgl_out2, b.no_gerobak3, b.tgl_out3, 
                                ...
                                <div class="form-group">
                                    <div class="col-sm-2">
                                        <select required name="operator" class="form-control" required>
                                            <option <?php if ($operator == 'ALL')
                                                echo 'selected' ?> value="ALL">ALL
                                                    OPERATOR</option>
                                            <?php while ($li = sqlsrv_fetch_array($sql_user)) { ?>
                                                <option <?php if ($operator == $li['nama'])
                                                    echo 'selected' ?> value="<?php echo $li['nama'] ?>">
                                                    <?php echo $li['nama'] ?>
                                                </option>
                                            <?php } ?>
                                        </select>
